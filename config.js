module.exports = {
  OWNER_IDS: ["1469310778518536265"], // Bot owner ID's
  SUPPORT_SERVER: "1479934584761356453", // Your bot support server
  PREFIX_COMMANDS: {
  ...
  INTERACTIONS: {
    ...
    TEST_GUILD_ID: "1479934584761356453", // Guild ID where the interactions should be registered. [** Test you commands here first **]
  },
  EMBED_COLORS: {
    BOT_EMBED: "#068ADD",
    TRANSPARENT: "#36393F",
